...
INSERT INTO training.profile (id, user_id, first_name, last_name, description, email, phone, gender) VALUES (default, 3, 'Jaan', 'Uss', null, 'client@client.ee', '44444433', 'M');
INSERT INTO training.profile (id, user_id, first_name, last_name, description, email, phone, gender) VALUES (default, 2, 'Nipi', 'Tiri', 'Ma olen ülikõva treener', 'coach@coach.ee', '112', 'M');
