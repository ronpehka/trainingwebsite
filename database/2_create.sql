...
ALTER TABLE coach_sport
    ADD CONSTRAINT coach_sport_sport
...
ALTER TABLE coach_sport
    ADD CONSTRAINT coach_sport_user
...
ALTER TABLE location
    ADD CONSTRAINT location_district
...
ALTER TABLE mailbox
    ADD CONSTRAINT mailbox_user_receiver
...
ALTER TABLE mailbox
    ADD CONSTRAINT mailbox_user_sender
...
ALTER TABLE register
    ADD CONSTRAINT register_training
...
ALTER TABLE training_date
    ADD CONSTRAINT training_date_training
        FOREIGN KEY (training_id)
            REFERENCES training (id)
            NOT DEFERRABLE
                INITIALLY IMMEDIATE
...
ALTER TABLE training_location
    ADD CONSTRAINT training_location_location
        FOREIGN KEY (location_id)
            REFERENCES location (id)
            NOT DEFERRABLE
                INITIALLY IMMEDIATE
...
ALTER TABLE training_location
    ADD CONSTRAINT training_location_training
        FOREIGN KEY (training_id)
            REFERENCES training (id)
            NOT DEFERRABLE
                INITIALLY IMMEDIATE
...
ALTER TABLE training_weekday
    ADD CONSTRAINT training_weekday_training
        FOREIGN KEY (training_id)
            REFERENCES training (id)
            NOT DEFERRABLE
                INITIALLY IMMEDIATE
...
ALTER TABLE training_weekday
    ADD CONSTRAINT training_weekday_weekday
